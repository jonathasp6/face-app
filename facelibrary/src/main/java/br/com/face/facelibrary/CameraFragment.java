...
public abstract class CameraFragment extends Fragment
    ...
    public CameraFragment(int textureId, int layoutId) {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            try {
                byte[] jpegData = ImageUtil.imageToByteArray(image2);
                processFrame(jpegData);
                image2.close();
            }
            catch (Exception e) {
                Log.e(TAG, "Camera's error. Trying to capture frame.");
            }
        }

    };

    public abstract void processFrame(byte[] jpegData);

    public abstract void startOthersThreads();
...
//        R.layout.fragment_camera2_basic
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = view.findViewById(textureId);
    }
